...
| AVX-512 / NEON kernels | <span class="st-ok" aria-label="implemented"><svg viewBox="0 0 12 12" width="13" height="13" aria-hidden="true"><path d="M2 6.4 4.7 9.2 10 3.2" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>| all-pairs + Barnes-Hut, validated on capable hardware |
| SIMD Barnes-Hut | <span class="st-ok" aria-label="implemented"><svg viewBox="0 0 12 12" width="13" height="13" aria-hidden="true"><path d="M2 6.4 4.7 9.2 10 3.2" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>| AVX2 / AVX-512 / NEON; validated; AVX2 measured slower than scalar |
...
| MPI + OpenMP + SIMD hybrid | <span class="st-ok" aria-label="implemented"><svg viewBox="0 0 12 12" width="13" height="13" aria-hidden="true"><path d="M2 6.4 4.7 9.2 10 3.2" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></span>| SIMD distributed traversal at scale |
